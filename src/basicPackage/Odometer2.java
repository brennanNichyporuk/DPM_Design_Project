...
public class Odometer2 implements TimerListener {
	...
	// constructor
	public Odometer2 (EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor, int INTERVAL, boolean autostart) {
		...
		this.leftRadius = this.rightRadius * 0.99;
		this.width = 11.35;
